...
## Why
Boss Sheets compress high-yield Qs for the night before an OA or interview. They are **library PDFs**, not a substitute for the full topic files.
...
- [LLD / Design Patterns Boss Sheet](https://drive.google.com/file/d/1vG8CqGV8kGYOqTbA812-mKHKyeP1jGAQ/view)
...
- Systems night: [Operating Systems](../topics/OS.md) · [C++](../topics/Cpp_Fundamentals.md) · [Concurrency](../topics/Concurrency_Multithreading.md)
- Product night: [DSA Overview](../topics/DSA/00_DSA_Overview.md) · [OOPs & LLD](../topics/OOPs_LLD.md)
- In-repo Boss footers index: [../03_BOSS_SHEETS.md](../03_BOSS_SHEETS.md)

## See also

- [📚 Library portal](README.md) · [🚪 START HERE](../START_HERE.md)
